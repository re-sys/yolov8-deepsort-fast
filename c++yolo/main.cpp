...
void test_deepsort(cv::Mat& frame, const std::vector<yolo::Detection> &results,tracker& mytracker)
{
    std::vector<yolo::Detection> objects;

    DETECTIONS detections;

    for (int i = 0; i < results.size(); ++i) 
    {
        yolo::Detection dr = results[i];
...
int main(int argc, char *argv[])
{
    ...
    cv::VideoCapture capture("/home/wu/Desktop/jia3.mp4");
    ...
    const std::string model_path = "/home/wu/Lab/DeepSORT/YOLOv8-OpenVINO-CPP-Inference/build/yolov8n_openvino_model/yolov8n.xml";
